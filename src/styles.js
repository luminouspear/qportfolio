...
<<<<<<< HEAD
	...
	heroSubText:
		"text-[#F5F2ED] font-light lg:text-[30px] sm:text-[26px] xs:text-[20px] text-[16px] lg:leading-[40px]",
=======
<<<<<<< HEAD
		"font-medium lg:text-[80px] sm:text-[60px] xs:text-[50px] text-[40px] lg:leading-[98px] mt-2",
	heroSubText:
		"text-[#F5F2ED] font-light lg:text-[30px] sm:text-[26px] xs:text-[20px] text-[16px] lg:leading-[40px]",
=======
		"font-medium lg:text-[80px] sm:text-[60px] text-[50px] text-[40px] lg:leading-[98px] mt-2",
	heroSubText:
...
<<<<<<< HEAD
			"sm:text-[16px] text-[13px] font-archivo text-qportfolio-white text-secondary uppercase tracking-wider",
=======
			"sm:text-[16px] text-[13px] font-archivo text-qportfolio-black uppercase tracking-wider",
>>>>>>> 5b195a3 (Some visual updates/stability changes)
>>>>>>> 53893bb (updates to UI)
